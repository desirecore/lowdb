...
var Low = exports.Low = /*#__PURE__*/function () {
  function Low(adapter, defaultData) {
    _classCallCheck(this, Low);
  ...
  return _createClass(Low, [{
    ...
    key: "update",
    value: function () {
      var _update = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(fn) {
...
var LowSync = exports.LowSync = /*#__PURE__*/function () {
  function LowSync(adapter, defaultData) {
    _classCallCheck(this, LowSync);
    _defineProperty(this, "adapter", void 0);
    _defineProperty(this, "data", void 0);
    checkArgs(adapter, defaultData);
    this.adapter = adapter;
